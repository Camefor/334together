  ...
  <div class="player">
    ...
    >
      <div v-show="fullScreen" :class="['normal-player', 'fullScreenFixed']">
        ...
        <!-- 背景图 -->
        <div
          :class="['background', { currentShow: currentShow === 'lyric' }]"
          ref="background"
        >
          <img
            :key="currentSong.id"
              ...
              <div :key="currentSong.id" class="cd-container">
                <div class="cd-wrap" ref="cdWrap">
                  <img
                    ...
                    :class="[
                      'cd',
                      { rotate: playing && !waiting && songReady },
                    ]"
                    :key="currentSong.pic"
            ...
            <transition name="toggle">
              <div class="curLyric-wrapper" :key="currentSong.id">
                <transition name="current">
                  <p class="ellipsis curLyric-text" :key="curLyric">
                    {{ curLyric }}
                  </p>
                </transition>
              </div>
          ...
          <div class="circle-progress" @click.stop="togglePlaying">
            ...
            >
              ...
              <i
                :class="[
                  'iconfont',
                  { 'icon-bofang2': !playing, 'icon-zanting': playing },
                ]"
              ></i>
            </x-circle>
          </div>
